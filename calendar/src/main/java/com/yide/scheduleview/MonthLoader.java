...
public class MonthLoader implements ScheduleEventViewLoader {
    ...
    @Override
    public List<? extends ScheduleEvent> onLoad(int periodIndex){
    ...
    public interface MonthChangeListener {
         ...
         */
        List<? extends ScheduleEvent> onMonthChange(int newYear, int newMonth);
    }
}

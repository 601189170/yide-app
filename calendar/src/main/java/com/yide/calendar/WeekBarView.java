...
import com.yide.calendar.common.ConvertUtil;
...
public class WeekBarView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mWeekSize = array.getDimension(R.styleable.WeekBarView_week_text_size,14);
        final boolean startWithSunday = array.getBoolean(R.styleable.WeekBarView_week_start_with_sunday, true);
        if (startWithSunday) {
            mWeekString = context.getResources().getStringArray(R.array.calendar_week_start_with_sun);
        } else {
            mWeekString = context.getResources().getStringArray(R.array.calendar_week_start_with_mon);
        }
        array.recycle();
    }

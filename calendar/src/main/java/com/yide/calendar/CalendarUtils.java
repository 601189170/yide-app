...
public class CalendarUtils {
     ...
     */
    public static int getFirstDayWeek(int year, int month,boolean startWithSunday) {
     ...
     * @return
     */
    public static int getWeeksAgo(int lastYear, int lastMonth, int lastDay, int year, int month, int day,boolean startWithSunday) {
    ...
    public static int getWeekRow(int year, int month, int day,boolean startWithSunday) {
        int week = getFirstDayWeek(year, month,startWithSunday);
        Calendar calendar = Calendar.getInstance();
        calendar.set(year, month, day);
        int lastWeek = calendar.get(Calendar.DAY_OF_WEEK);
        Log.d(TAG, "getWeekRow: startWithSunday="+startWithSunday+",week="+week);
        if (lastWeek == 7)
            day--;
    ...
    public static int getMonthRows(int year, int month,boolean startWithSunday) {
        int size = getFirstDayWeek(year, month,startWithSunday) + getMonthDays(year, month) - 1;

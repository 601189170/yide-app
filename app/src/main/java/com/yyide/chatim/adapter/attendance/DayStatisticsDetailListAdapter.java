 ...
 * @Version: 1.0
 */
public class DayStatisticsDetailListAdapter extends RecyclerView.Adapter<DayStatisticsDetailListAdapter.ViewHolder> {
    ...
    public DayStatisticsDetailListAdapter(Context context, List<AttendanceWeekStatsRsp.DataBean.AttendancesFormBean.StudentsBean.PeopleBean> data) {

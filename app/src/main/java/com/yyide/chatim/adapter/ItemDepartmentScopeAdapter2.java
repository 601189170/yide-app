 ...
 * @Version: 1.0
 */
public class ItemDepartmentScopeAdapter2 extends RecyclerView.Adapter<ItemDepartmentScopeAdapter2.ViewHolder> {
    private Context context;
    private List<DepartmentScopeRsp.DataBean.ListBeanXX> data;
    private boolean unfold = false;
    public ItemDepartmentScopeAdapter2(Context context, List<DepartmentScopeRsp.DataBean.ListBeanXX> data) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        DepartmentScopeRsp.DataBean.ListBeanXX bean = data.get(position);
...
//            holder.mRecyclerView.addItemDecoration(new DividerItemDecoration(context, DividerItemDecoration.VERTICAL));
        ...
        holder.checkBox.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            List<DepartmentScopeRsp.DataBean.ListBeanXX.ListBeanX> classes = bean.getList();

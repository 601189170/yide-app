...
public class WheelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        lineColor = attribute.getColor(R.styleable.WheelView_lineColorWv, lineColor);
    ...
    private void drawLine(Canvas canvas) {
        ...
        canvas.drawRect(0,controlHeight / 2 - unitHeight / 2 + lineHeight,controlWidth,controlHeight / 2 + unitHeight / 2 - lineHeight,bgPaint);
    }

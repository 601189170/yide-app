...
public class TextVerticalProgressBar extends ProgressBar {
    ...
    public TextVerticalProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (progressPosX + textWidth > mRealHeight) {
            textPosX = mRealHeight - textWidth;
            if (mTextAlign == TEXT_ALIGN_MIDDLE) {
...
//            canvas.drawLine(0, mRealHeight, 0, 0, mPaint);
//            return;
//        }
...
//        mRectF.set(unreachedStartX, top, mRealHeight, mUnReachedBarHeight + top);
//        Path path;

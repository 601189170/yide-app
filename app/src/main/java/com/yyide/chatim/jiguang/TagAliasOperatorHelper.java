...
public class TagAliasOperatorHelper {
    ...
    public void onAliasOperatorResult(Context context, JPushMessage jPushMessage) {
        ...
        if (jPushMessage.getErrorCode() == 0) {
            SPUtils.getInstance().put(BaseConstant.JG_SEQUENCE, jPushMessage.getSequence());
            SPUtils.getInstance().put(BaseConstant.JG_ALIAS_NAME, jPushMessage.getAlias());
            registerAlias(jPushMessage.getAlias(), JPushInterface.getRegistrationID(context.getApplicationContext()));

...
public class StudentWeekStatisticsFragment extends BaseMvpFragment<StudentWeekMonthStatisticsPresenter> implements StudentWeekMonthStatisticsView, SwipeRefreshLayout.OnRefreshListener {
    ...
    public StudentWeekStatisticsFragment(String type) {
        // Required empty public constructor
        this.type = type;
    }


    public static StudentWeekStatisticsFragment newInstance(String type) {
        StudentWeekStatisticsFragment fragment = new StudentWeekStatisticsFragment("");

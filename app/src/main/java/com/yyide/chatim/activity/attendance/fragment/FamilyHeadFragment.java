 ...
 * other lrz
 */
public class FamilyHeadFragment extends BaseMvpFragment<AttendanceCheckPresenter> implements AttendanceCheckView, View.OnClickListener {

    private FragmentFamilyHeadBinding mViewBinding;
    private String TAG = FamilyHeadFragment.class.getSimpleName();

    public static FamilyHeadFragment newInstance() {
        FamilyHeadFragment fragment = new FamilyHeadFragment();
    ...
    BaseQuickAdapter adapter = new BaseQuickAdapter<AttendanceCheckRsp.DataBean.AttendancesFormBean, BaseViewHolder>(R.layout.item_attendance_family_head) {
        ...
        protected void convert(@NotNull BaseViewHolder holder, AttendanceCheckRsp.DataBean.AttendancesFormBean item) {
            ...
            holder.setText(R.id.tv_event_name, students.getName())
                    .setText(R.id.tv_attendance_card_time, getString(R.string.attendance_punch_card_text, students.getAttendanceData()))
                    .setText(R.id.tv_attendance_time, getString(R.string.attendance_time_text, students.getAttendanceData()));

...
import com.yyide.chatim_pro.model.MyUserInfo;
...
import com.yyide.chatim_pro.model.NoticePermissionBean;
...
import com.yyide.chatim_pro.model.SearchRsp;
...
import com.yyide.chatim_pro.model.UpdateUserInfo;
...
import com.yyide.chatim_pro.model.UserNoticeRsp;
...
import com.yyide.chatim_pro.model.gate.GateDataPermissionRsp;
...
import com.yyide.chatim_pro.model.schedule.ScheduleListRsp;
...
import com.yyide.chatim_pro.model.schedule.Settings;
import com.yyide.chatim_pro.model.schedule.StudentGuardianRsp;
import com.yyide.chatim_pro.model.schedule.TodayListRsp;
...
//    @POST("/management/cloud-system/v1/app/addressBookApp/searchAddressBook")
    ...
    //获取消息分页
    @Headers({"Content-Type: application/json", "Accept: application/json"})
    @POST("/cloud/v2/push/pageUserMessage")
    Observable<UserMsgNoticeRsp> queryUserMessageNotice(@Body RequestBody requestBody);

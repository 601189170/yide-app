...
class SwitchIdentityPop(var context: Activity) : PopupWindow() {
    ...
    private fun init() {
        ...
        mView.findViewById<Button>(R.id.btnConfirm).setOnClickListener {
            //login()
        }
    ...
    private fun login(identityId: Long, schoolId: Long) {
        ...
        mOkHttpClient.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                val bean = JSON.parseObject(data, LoginRsp::class.java)

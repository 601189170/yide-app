package com.yyide.chatim_pro.widget.scrollpicker.view;
...
import com.yyide.chatim_pro.widget.scrollpicker.IPickerViewOperation;
import com.yyide.chatim_pro.widget.scrollpicker.util.ScreenUtil;
...
public class ScrollPickerView extends RecyclerView {
    ...
    public void doDraw(Canvas canvas) {
        if (mItemHeight > 0) {
            ...
            //canvas.drawRect(startX,mFirstLineY,stopX,mSecondLineY,mBgPaint);
            canvas.drawRect(0,mFirstLineY,screenX,mSecondLineY,mBgPaint);
        }
    }
    ...
    private void updateView(View itemView, boolean isSelected) {
        Log.e("TAG", "updateView: "+itemView.getTag()+","+isSelected );
        IPickerViewOperation operation = (IPickerViewOperation) getAdapter();
        if (operation != null) {

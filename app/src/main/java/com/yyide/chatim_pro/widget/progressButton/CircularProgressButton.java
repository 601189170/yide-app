package com.yyide.chatim_pro.widget.progressButton;
...
public class CircularProgressButton extends androidx.appcompat.widget.AppCompatButton {
    ...
    private StrokeGradientDrawable createDrawable(int color) {
        GradientDrawable drawable = (GradientDrawable) getResources().getDrawable(R.drawable.bg_blue_corner_14dp).mutate();
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int grey = getColor(R.color.voice_pressed);

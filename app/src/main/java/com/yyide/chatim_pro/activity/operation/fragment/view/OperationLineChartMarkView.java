package com.yyide.chatim_pro.activity.operation.fragment.view;
...
public class OperationLineChartMarkView extends MarkerView {
    private TextView tv_name;
    private TextView tv_this_week;
    private TextView tv_last_week;
    private IAxisValueFormatter xAxisValueFormatter;

    public OperationLineChartMarkView(Context context, IAxisValueFormatter xAxisValueFormatter) {
        super(context, R.layout.dialog_operation_chart_desc);

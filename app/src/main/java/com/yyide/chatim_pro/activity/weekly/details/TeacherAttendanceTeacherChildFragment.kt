...
import com.yyide.chatim_pro.activity.weekly.details.adapter.TeacherAttendanceAdapter
...
//        barDataSet.barShadowColor = Color.parseColor("#01000000")
    ...
    private fun convertDataToTreeNode(
        ...
        val name =
            if (!TextUtils.isEmpty(data.clockName)) data.clockName else SpData.getIdentityInfo().identityName

...
import com.yyide.chatim_pro.activity.weekly.details.adapter.StudentAttendanceAdapter
import com.yyide.chatim_pro.base.BaseFragment
import com.yyide.chatim_pro.databinding.FragmentTeacherChildWeeklyAttendanceBinding
import com.yyide.chatim_pro.model.AttendItem
import com.yyide.chatim_pro.model.StudentDetail
import com.yyide.chatim_pro.model.StudentNumber
import com.yyide.chatim_pro.model.StudentValue
...
//        barDataSet.barShadowColor = Color.parseColor("#01000000")
    ...
    private fun convertDataToTreeNode(
        ...
        for (item in datas) {
            ...
            val itemChild =
                StudentValue(item.name, item.type, "", "", mutableListOf())

...
import com.yyide.chatim_pro.databinding.FragmentScheduleBinding
...
import com.yyide.chatim_pro.viewmodel.*
...
//        setFragment(0)
    ...
    fun setTab(position: Int) {
        ...
        fragmentScheduleBinding.viewPager.adapter = @SuppressLint("WrongConstant")
        object :
